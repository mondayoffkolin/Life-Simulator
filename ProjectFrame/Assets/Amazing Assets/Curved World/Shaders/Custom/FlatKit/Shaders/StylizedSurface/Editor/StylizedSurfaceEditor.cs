...
public class StylizedSurfaceEditor : UnityEditor.ShaderGUI {
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties) {
        ...
        if (UnityEngine.Rendering.GraphicsSettings.renderPipelineAsset != null && HasProperty("_Cull")) {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                _target.doubleSidedGI = (RenderFace)cullingProp.floatValue != RenderFace.Front;
            }
        }
